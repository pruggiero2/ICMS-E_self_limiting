...
stargazer(model01,model02,model03,model04, type = "latex", digits = 4, title = "ICMS-E impacts on new state and municipal PAs, as the percentage of total municipal area.", align = TRUE, covariate.labels = ind.v, no.space = TRUE, out = "icmse_amc_table2.tex")
