...
stargazer(m1s,m2s,m3s,m4s, type = "latex", digits = 4, title = "ICMS-E impacts on new state and municipal PAs, as the percentage of total municipal area.", align = TRUE, covariate.labels = ind.v, no.space = TRUE, out = "tableS5.tex")
```
