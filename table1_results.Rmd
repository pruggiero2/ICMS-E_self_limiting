...
# ICMS-E results - Law:MGIRS UNWEIGHTED
...
```{r, echo=FALSE, results='hide'}
m2s <- coeftest(model02, vcovCR(model02, cluster = master$codigo, type = "CR1S"))
m2s
```
...
```{r}
setwd("/Users/Patricia/Dropbox/doutorado/parte2_ICMS_eco/analises/amc")
...
stargazer(m1s,m2s,m3s,m4s, type = "latex", digits = 4, title = "ICMS-E impacts on new state and municipal PAs, as the percentage of total municipal area.", align = TRUE, covariate.labels = ind.v, no.space = TRUE, out = "icmse_amc_table1.tex")
```
